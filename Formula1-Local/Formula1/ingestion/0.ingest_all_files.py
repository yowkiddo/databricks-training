...
v_result = dbutils.notebook.run("1.ingestion_circuits_file", 0, {"p_data_source": "Ergast API"}, {"p_file_date": "2021-03-21"})
...
v_result = dbutils.notebook.run("2.ingestion_races_file", 0, {"p_data_source": "Ergast API"}, {"p_file_date": "2021-03-21"})
